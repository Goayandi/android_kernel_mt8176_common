...
#if 0
#define WISKY_DEBUG printk
#else
#define WISKY_DEBUG pr_debug
#endif
...
static int mmc_sd_get_cd(void) 
{
	int  level = __gpio_get_value(cd_pin);
	WISKY_DEBUG("cd-level=%d\n",level);
