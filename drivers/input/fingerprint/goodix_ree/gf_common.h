...
#define GF_NAV_INPUT_RESERVED    KEY_RESERVED
#define GF_NAV_INPUT_UP			KEY_RESERVED//KEY_UP
#define GF_NAV_INPUT_DOWN		KEY_RESERVED//KEY_DOWN
#define GF_NAV_INPUT_LEFT		KEY_RESERVED//KEY_LEFT
#define GF_NAV_INPUT_RIGHT		KEY_RESERVED//KEY_RIGHT
#define GF_NAV_INPUT_CLICK		KEY_CAMERA//KEY_VOLUMEDOWN
#define GF_NAV_INPUT_DOUBLE_CLICK	KEY_APPSELECT//KEY_VOLUMEUP
#define GF_NAV_INPUT_LONG_PRESS		KEY_HOMEPAGE//KEY_SEARCH
...
struct gf_device {
	...
	int device_count;
	struct mt_tl_chip_conf spi_mcc;
