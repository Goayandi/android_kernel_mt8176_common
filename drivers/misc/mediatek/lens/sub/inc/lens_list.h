...
#ifdef CONFIG_MTK_LENS_FM51AF_SUPPORT
//#define FM51AF_SetI2Cclient FM51AF_SetI2Cclient_Sub
//#define FM51AF_Ioctl FM51AF_Ioctl_Sub
//#define FM51AF_Release FM51AF_Release_Sub
extern void FM51AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long FM51AF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int FM51AF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
