...
extern unsigned int g_is_suspend; 
/* --------------------------------------------------------------------------- */
/* Local Variables */
/* --------------------------------------------------------------------------- */
...
unsigned int GPIO_LCD_RESET_EN;
unsigned int GPIO_LED;
// struct regulator *REGULATOR_VGP4;
unsigned int GPIO_LCD_PWR2_EN;
//unsigned int GPIO_LCD_BL_EN;
...
{
	printk("lcm_set_gpio_output GPIO=%d\n",GPIO);
#ifdef BUILD_LK
...
static void lcm_init(void)
{
	...
	#else
    printk("%s,lcm_init lq101r1sx01a_wqxga_dsi_vdo kernel\n", __func__);
	#endif
...
{
		lcm_set_gpio_output(GPIO_LED, GPIO_OUT_ZERO);
		MDELAY(10);
		lcm_set_gpio_output(GPIO_LCD_RESET_EN, GPIO_OUT_ZERO);
		MDELAY(10);
...
printk("lcm_resume_power\n");
	...
	upmu_set_rg_vgp4_sw_en(1);
	MDELAY(15);
	lcm_set_gpio_output(GPIO_LCD_RESET_EN, GPIO_OUT_ONE);
	MDELAY(80);
		lcm_set_gpio_output(GPIO_LCD_RESET_EN, GPIO_OUT_ZERO);
	MDELAY(20);
	lcm_set_gpio_output(GPIO_LCD_RESET_EN, GPIO_OUT_ONE);
...
static void lcm_resume(void)
{
	//enable VSP & VSN
#ifdef BUILD_LK
    printf("lq101r1sx01a,lcm_resume LK \n");
#else
    printk("lq101r1sx01a,lcm_resume kernel");
#endif	
	lcm_resume_power();
