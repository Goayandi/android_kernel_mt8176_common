...
/*LTR303 als/ps sensor register related macro*/
#define LTR303_ALS_CONTR		0x80
#define LTR303_PS_CONTR			0x81
#define LTR303_PS_LED			0x82
#define LTR303_PS_N_PULSES		0x83
#define LTR303_PS_MEAS_RATE		0x84
#define LTR303_ALS_MEAS_RATE	0x85
#define LTR303_PART_ID	        0x86
#define LTR303_MANUFACTURER_ID	0x87

#define LTR303_INTERRUPT		0x8F
#define LTR303_PS_THRES_UP_0	0x90
#define LTR303_PS_THRES_UP_1	0x91
#define LTR303_PS_THRES_LOW_0	0x92
#define LTR303_PS_THRES_LOW_1	0x93

#define LTR303_PS_OFFSET_1		0x94
#define LTR303_PS_OFFSET_0		0x95
...
#define LTR303_PS_DATA_0		0x8D
#define LTR303_PS_DATA_1		0x8E
...
#define LTR303_IOCTL_PS_ENABLE		_IOW(LTR303_IOCTL_MAGIC, 0, char *)
#define LTR303_IOCTL_ALS_ENABLE		_IOW(LTR303_IOCTL_MAGIC, 1, char *)
#define LTR303_IOCTL_READ_PS_DATA	_IOR(LTR303_IOCTL_MAGIC, 2, char *)
#define LTR303_IOCTL_READ_PS_INT	_IOR(LTR303_IOCTL_MAGIC, 3, char *)
