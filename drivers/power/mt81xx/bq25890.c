...
{
	bq25890_config_interface((u8) (bq25890_CON0),
...
u32 bq25890_get_iinlim(void)
{
	...
	bq25890_read_interface((u8) (bq25890_CON0),
...
{
	bq25890_config_interface((u8) (bq25890_CON2),
				 (u8) (val),
...
u32 bq25890_get_dpdm_status(void)
{
	...
	bq25890_read_interface((u8) (bq25890_CON2),
...
{
	bq25890_config_interface((u8) (bq25890_CON3),
...
{
	bq25890_config_interface((u8) (bq25890_CON4),
...
u32 bq25890_get_pumpx_en(void)
{
	...
	bq25890_read_interface((u8) (bq25890_CON4),
...
{
	bq25890_config_interface((u8) (bq25890_CON5),
...
{
	bq25890_config_interface((u8) (bq25890_CON6),
...
{
	bq25890_config_interface((u8) (bq25890_CON7),
...
{
	bq25890_config_interface((u8) (bq25890_CON8),
...
u32 bq25890_get_pumpx_up(void)
{
	...
	bq25890_read_interface((u8) (bq25890_CON9),
...
{
	bq25890_config_interface((u8) (bq25890_CON9),
...
{
	bq25890_config_interface((u8) (bq25890_CON10),
				 (u8) (val),
...
u32 bq25890_get_vbus_stat(void)
{
	...
	bq25890_read_interface((u8) (bq25890_CON11),
...
u32 bq25890_get_system_status(void)
{
	...
	bq25890_read_interface((u8) (bq25890_CON11), (&val), (u8) (0xFF), (u8) (0x0)
	    );
	return val;
}
...
{
	bq25890_config_interface((u8) (bq25890_CON13),
				 (u8) (val),
...
u32 bq25890_get_vdpm_stat(void)
{
	...
	bq25890_read_interface((u8) (bq25890_CON19),
...
{
	bq25890_config_interface((u8) (bq25890_CON20),
...
u32 bq25890_get_pn(void)
{
	...
	bq25890_read_interface((u8) (bq25890_CON20),
...
static u32 charging_hw_init(void *data)
{
	...
	/* ICO_EN default off */
	bq25890_config_interface(bq25890_CON2, 0x0, CON2_ICO_EN_MASK, CON2_ICO_EN_SHIFT);
	/* disable MAXC_EN and HVDCP_EN */
	bq25890_config_interface(bq25890_CON2, 0x1, CON2_HVDCP_EN_MASK, CON2_HVDCP_EN_SHIFT);
	bq25890_config_interface(bq25890_CON2, 0x1, CON2_MAXC_EN_MASK, CON2_MAXC_EN_SHIFT);
				    ...
				    const char *buf, size_t size)
{
	...
	if (buf != NULL && size != 0) {
		...
		if (size > 4) {
			...
			bq25890_config_interface(reg_address, reg_value, 0xFF, 0x0);
		} else {
			...
			bq25890_read_interface(reg_address, &g_reg_value_bq25890, 0xFF, 0x0);
			pr_debug("[store_bq25890_access] read bq25890 reg 0x%x with value 0x%x !\n",
