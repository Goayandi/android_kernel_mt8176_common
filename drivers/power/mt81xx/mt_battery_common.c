...
extern void battery_pump_express_charger_check(void);
...
#define RECOVERY_CHARGING_TEMPERATURE  35
...
static struct mt_battery_charging_custom_data default_charging_data = {
	...
	.max_discharge_temperature = 60,//60
	.min_discharge_temperature = -5,
	.max_charge_temperature = 60,//50
	.min_charge_temperature = -5,//0
	...
	.ac_charger_current = CHARGE_CURRENT_2000_00_MA,
	.ac_charger_input_current = CHARGE_CURRENT_2500_00_MA,
	.non_std_ac_charger_current = CHARGE_CURRENT_2500_00_MA,
	...
	.v_charger_max = 12500,	/* 12.5 V */
	.v_charger_min = 4400,	/* 4.4 V */
	.battery_cv_voltage = BATTERY_VOLT_04_352000_V,
	...
	.jeita_recharge_voltage = 4200,	/* for linear charging */
	...
	.jeita_temp_pos_10_to_pos_45_cv_voltage = BATTERY_VOLT_04_400000_V,
	...
	.ta_ac_9v_input_current = CHARGE_CURRENT_1700_00_MA,
	.ta_ac_7v_input_current = CHARGE_CURRENT_1500_00_MA,
	.ta_ac_charging_current = CHARGE_CURRENT_3500_00_MA,
	.ta_9v_support = 1,
};
...
static void battery_update(struct battery_data *bat_data)
{
	...
	//printk("w100 test battery_update\n");
...
{
	//printk("w100 pmic_chrdet_status\n");
...
static void mt_battery_charger_detect_check(void)
{
	...
	//printk("w100 mt_battery_charger_detect_check\n");
	if (upmu_is_chr_det() == true) {
...
{
	//printk("w100 do_chrdet_int_task\n");
...
irqreturn_t ops_chrdet_int_handler(int irq, void *dev_id)
{
	...
	//printk("w100 ops_chrdet_int_handler\n");
	do_chrdet_int_task();
...
void BAT_thread(void)
{
	...
	//printk("w100 ready to mt_battery_update_status\n");
	//wujie
...
static long adc_cali_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
	...
	case ADC_CHANNEL_READ:
		...
		if (adc_in_data[0] == 0)	/* I_SENSE */
			...
			adc_out_data[0] = BMT_status.ICharging;//wisky-lxh@20160805,factory get charging current
		} else {
