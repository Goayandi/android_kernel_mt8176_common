...
#ifndef _BQ25892_SW_H_
#define _BQ25892_SW_H_

#define BQ25892_CON0	0x00
#define BQ25892_CON1	0x01
#define BQ25892_CON2	0x02
#define BQ25892_CON3	0x03
#define BQ25892_CON4	0x04
#define BQ25892_CON5	0x05
#define BQ25892_CON6	0x06
#define BQ25892_CON7	0x07
#define BQ25892_CON8	0x08
#define BQ25892_CON9	0x09
#define BQ25892_CON10	0x0A
#define BQ25892_CON11	0x0B
#define BQ25892_CON12	0x0C
#define BQ25892_CON13	0x0D
#define BQ25892_CON14	0x0E
#define BQ25892_CON15	0x0F
#define BQ25892_CON16	0x10
#define BQ25892_CON17	0x11
#define BQ25892_CON18	0x12
#define BQ25892_CON19	0x13
#define BQ25892_CON20	0x14
...
/**********************************************************
  ...
  *********************************************************/
/* CON0---------------------------------------------------- */
extern void bq25892_set_en_hiz(u32 val);
extern void bq25892_set_iinlim(u32 val);
extern u32 bq25892_get_iinlim(void);
/* CON1---------------------------------------------------- */
/* CON2---------------------------------------------------- */
extern void bq25892_set_force_dpdm(u32 val);
extern void bq25892_set_auto_dpdm_en(u32 val);
extern u32 bq25892_get_dpdm_status(void);
/* CON3---------------------------------------------------- */
extern void bq25892_set_wdt_rst(u32 val);
extern void bq25892_set_otg_config(u32 val);
extern void bq25892_set_chg_config(u32 val);
extern void bq25892_set_sys_min(u32 val);
/* CON4---------------------------------------------------- */
extern void bq25892_set_ichg(u32 val);
extern u32 bq25892_get_ichg(void);
/* CON5---------------------------------------------------- */
extern void bq25892_set_iprechg(u32 val);
extern void bq25892_set_iterm(u32 val);
/* CON6---------------------------------------------------- */
extern void bq25892_set_vreg(u32 val);
extern void bq25892_set_batlowv(u32 val);
extern void bq25892_set_vrechg(u32 val);
/* CON7---------------------------------------------------- */
extern void bq25892_set_en_term(u32 val);
extern void bq25892_set_watchdog(u32 val);
extern void bq25892_set_en_timer(u32 val);
extern void bq25892_set_chg_timer(u32 val);
/* CON8---------------------------------------------------- */
extern void bq25892_set_treg(u32 val);
/* CON9---------------------------------------------------- */
extern void bq25892_set_batfet_disable(u32 val);
/* CON10---------------------------------------------------- */
extern void bq25892_set_boost_lim(u32 val);
/* CON11---------------------------------------------------- */
extern u32 bq25892_get_system_status(void);
extern u32 bq25892_get_vbus_stat(void);
extern u32 bq25892_get_chrg_stat(void);
extern u32 bq25892_get_pg_stat(void);
extern u32 bq25892_get_vsys_stat(void);
/* CON13---------------------------------------------------- */
extern void bq25892_set_vindpm(u32 val);
/* CON19---------------------------------------------------- */
extern u32 bq25892_get_vdpm_stat(void);
extern u32 bq25892_get_idpm_stat(void);
extern u32 bq25892_get_current_iinlim(void);
/* CON20---------------------------------------------------- */
extern void bq25892_set_reg_rst(u32 val);
extern u32 bq25892_get_pn(void);
extern u32 bq25892_get_rev(void);
/* --------------------------------------------------------- */


extern void bq25892_dump_register(void);
extern u32 bq25892_read_interface(u8 RegNum, u8 *val, u8 MASK, u8 SHIFT);
